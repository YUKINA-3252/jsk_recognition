...
class PaperFinder(ConnectionBasedTransport):
    ...
    def __init__(self):
        ...
        self.pose_array_pub = self.advertise('~output/pose',
                                             ...
                                             queue_size=1)
        self.bounding_box_array_pub = self.advertise('~output/box',
                                             BoundingBoxArray,
                                             queue_size=1)
    ...
    def _cb_with_depth(self, img_msg, depth_msg):
        ...
        new_squares = []
        valid_xyz_corners = []
        length_array_forPublish = std_msgs.msg.Float32MultiArray()
        for si, xyz in enumerate(xyzs):
            ...
            length_array_forPublish.append(length_array)
            """
            length_array = []
            ...
            length_array_forPublish = std_msgs.msg.Float32MultiArray(data=length_array)
        ...
        self.length_array_pub.publish(length_array_forPublish)
        ...
        for xyz in valid_xyz_corners:
            ...
            bounding_box_array.dimensions.y = (lengths[indices[0]] + lengths[indices[1]]) / 2.0
            bounding_box_array.dimensions.z = (lengths[indices[2]] + lengths[indices[3]]) / 2.0
