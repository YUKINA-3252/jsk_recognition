...
from jsk_recognition_msgs import BoundingBoxArray, BoundingArray
...
class PaperFinder(ConnectionBasedTransport):
    ...
    def _cb_with_depth(self, img_msg, depth_msg):
        ...
        new_squares = []
        valid_xyz_corners = []
        length_array_forPublish = BoundingBoxArray()
        for si, xyz in enumerate(xyzs):
            ...
            paper = BoundingBox()
            paper.header.stamp = msg.header.stamp
            paper.pose.position.z = 
